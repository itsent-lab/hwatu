...
const AI_DIFFICULTY_KEY = 'nsj-hwatu-ai-difficulty-v1';
const GOSTOP_AI_DIFFICULTY_KEY = 'nsj-hwatu-gostop-ai-difficulty-v1';
const POINT_VALUE_KEY = 'nsj-hwatu-point-value-v1';
const GOSTOP_POINT_VALUE_KEY = 'nsj-hwatu-gostop-point-value-v1';
const DISCARD_CONFIRMATION_KEY = 'nsj-hwatu-discard-confirmation-v1';
